	...
	<section class="blog_view_wrap" aria-labelledby="blog-view-title" data-header="light">
		...
		<div class="blog_view_con mojo_aos">
			...
			<div class="view_btm">
				...
				<div class="right">
					<button type="button" class="like" aria-pressed="false" aria-label="좋아요"><span aria-hidden="true"><i></i><p>좋아요<strong id="blog_like_count">{{ number_format($likeCount) }}</strong></p></span></button>
