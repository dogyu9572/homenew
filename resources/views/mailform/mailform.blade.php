...
<section style="width:600px; margin:0 auto; font-family:'Pretandard', sans-serif;">
	<section style="display:flex; align-items:center; gap:10px; padding:30px 0; border-bottom:#ddd 1px solid;">
		<img src="https://homenew.hk-test.co.kr/images/logo.png" alt="홈페이지코리아">
		<span style="font-size:24px; color:#040404; font-weight:600;">문의 접수 안내</span>
	</section>
	<div style="width:100%; height:5px; background:linear-gradient(90deg,#142B93,#0391E7);" aira-hidden="true"></div>
	
	<section style="padding:80px 0;">
		<h1 style="font-size:18px; color:#040404; font-weight:600; line-height:1.2; margin-bottom:30px;">{이메일 주소} 님의 문의가 정상적으로 접수되었습니다.</h1>
		...
		<div style="padding:20px; text-align:center; margin-top:50px;">
			<a href="https://homenew.hk-test.co.kr/about/" target="_blank" style="padding:15px; border-radius:30px; margin:0 5px; font-size:15px; color:#fff; background:linear-gradient(90deg,#142B93,#0391E7);">회사소개서 바로가기</a>
			<a href="https://homenew.hk-test.co.kr/ebook/index.html#page=1" target="_blank" style="padding:15px; border-radius:30px; margin:0 5px; font-size:15px; color:#fff; background:linear-gradient(90deg,#142B93,#0391E7);">AI 시대, 성과를 만드는 홈페이지의 비밀 Ebook 바로가기</a>
		</div>
	</section>
	<div style="width:100%; height:5px; background:linear-gradient(90deg,#142B93,#0391E7);" aira-hidden="true"></div>
