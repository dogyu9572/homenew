	...
	<section class="infopage_head industry_head main_service" aria-labelledby="industry-head-title">
		...
		<div class="inner">
			...
			<div class="problem service">
				...
				<h2 id="industry-problem-title"><strong>기업용 웹사이트 제작,</strong>이런 고민이 있으신가요?</h2>
				<ul class="problem_list">
					<li>
						<h3>복잡한 내부 시스템과 홈페이지를 연동시키고 싶어요. 😵‍💫</h3>
						<p>ERP, CRM, LMS 등 기존 시스템과 웹사이트가 유기적으로 연결되어야 하는데, 데이터 호환성과 보안 이슈로 통합이 어렵습니다.</p>
					</li>
					<li>
						<h3>까다로운 보안 요구사항을 충족시킬 수 있는 업체, 어디 없을까요? 🤔</h3>
						<p>개인정보보호법, 정보보안 정책, 내부망/외부망 분리 등 엄격한 보안 기준을 만족하는 개발사를 찾기 어렵습니다.</p>
					</li>
					<li>
						<h3>담당자 변경에도 지속 가능한 시스템이 필요합니다. 😭</h3>
			...
			<ul class="why_list">
				<li>
					...
					<div class="txt">
						...
						<p>1999년부터 <strong>대기업, 중견기업 등 복잡한 요구사항을 가진 프로젝트를 수행</strong>하며 <br class="pc_vw">쌓은 노하우로 <strong>프로젝트 성공률 99%</strong>를 유지하고 있습니다.</p>
				...
				<li>
					...
					<div class="txt">
						...
						<p>대형 프로젝트는 <strong>대기업/기관 경험이 풍부한 전문 PM이 전담</strong>합니다.<br/>기술적 이슈를 빠르게 파악하고, <strong>복잡한 요구사항도 정확히 구현</strong>합니다.</p>
					</div>
				</li>
				<li>
					...
					<div class="txt">
						...
						<p>자체 개발팀이 <strong>React, Laravel, Next.js 등 최신 기술 스택으로 자체 개발</strong>하여 기업의 고유한 요구사항도 정확히 구현합니다.</p>
					</div>
				</li>
				<li>
					...
					<div class="txt">
						...
						<p>디자인만 예쁜 웹사이트가 아니라, <strong>검색 엔진과 AI에 최적화된 구조로 설계</strong>하여 <strong>자연 유입 트래픽을 확보</strong>하고 <strong>온라인 가시성</strong>을 높입니다.</p>
					</div>
				</li>
				<li>
		...
		<div class="inner">
			...
			<ul class="review_list">
				<li>
					...
					<h4>금융권이라 보안 요구사항이 까다로운데, <strong>전자정부프레임워크 기반</strong>으로 안정적으로 구축해주셨어요.<br/>
					<br/>
					<strong>내부망/외부망 분리 환경에서도 문제없이 작동하고, 취약점 점검까지 완료</strong>해서 보안 심사를 무사히 통과할 수 있었습니다.</h4>
				...
				<li>
					...
					<h4>여러 브랜드를 운영하다 보니 마케팅팀과 <br class="pc_vw">IT팀의 요구사항이 달라 조율이 어려웠는데요.<br/>
					<br/>
					<strong>홈페이지코리아 PM분이 양쪽의 니즈를 모두 이해하고 최적의 방안을 제시</strong>해주셨어요.</h4>
				...
				<li>
					...
					<h4>우리 회사의 복잡한 <strong>B2B 거래 특성을 <br class="pc_vw">	완벽히 이해하고 그에 맞게 구축해주었습니다.</strong><br/>
					요청사항을 신속하게 반영해주어 높은 만족도로 사용하고 있습니다.<br/>
					<br/>
					구축 후 불필요한 수작업이 줄고 <br class="pc_vw">주문/재고 관리 시스템이 일원화되어 <br class="pc_vw"><strong>업무 효율이 비약적으로 올랐습니다.</strong></h4>
