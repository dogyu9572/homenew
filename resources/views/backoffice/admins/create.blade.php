                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select id="department" name="department">
                                ...
                                @foreach($departmentOptions as $departmentOption)
                                    <option value="{{ $departmentOption }}" @selected(old('department') === $departmentOption)>{{ $departmentOption }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="position" name="position" value="{{ old('position') }}" maxlength="255" placeholder="직급을 입력하세요">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('manual_used_leave_days', '0') }}"
                                step="0.01"
                                min="0"
                                placeholder="0"
                            >
